...
use Nautic\Http\Requests\CreateModelRequest;
use Nautic\Http\Requests\UpdateModelRequest;
use Nautic\Repositories\ShipyardRepository;
use Nautic\Http\Controllers\AppBaseController as AppBaseController;
use Nautic\Models\Image;

class ShipyardController extends AppBaseController
{
    private $repo;
    private $gender;
    private $model;
    ...
    public function __construct(ShipyardRepository $repository)
    {	

        $this->repo                 = $repository;
        $this->gender               = 'M';
        $this->model                = 'shipyard';
        $this->modelPlural          = 'shipyarda';
        $this->modelSpanish         = 'astillero';
        $this->modelSpanishPlural   = 'astilleros';
